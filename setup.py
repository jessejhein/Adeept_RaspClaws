...
"sudo pip3 install mediapipe==0.10.18",  # optional hand tracking (solutions API)
]
commands_pip_2 = [
...
"sudo pip3 install mediapipe==0.10.18 --break-system-packages",  # optional hand tracking (solutions API)
]
mark_pip = 0
